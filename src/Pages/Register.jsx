    ...
    return (
        <div className='login'>
            ...
            <div className='absolute max-w-3xl mx-3 md:mx-auto top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 -translate-y-1/2'>
                <p className="text-4xl text-white text-center my-8">Register</p>
                <form action="/submit-form" method="POST">
                    ...
                    <label for="email" className='text-lg text-white font-medium'>Your Email:</label>
                    <input type="email" className='border w-full rounded-md px-4 py-2 border-gray-300 my-3' placeholder='Name' id="name" name="name" required />
                    ...
                    <p className="text-lg text-center text-white py-3">Already have an account? <Link to="/login" className='hover:text-red-500'>Login Now</Link></p>
